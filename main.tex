...
\begin{document}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} TypeScript, Kotlin, Python, \par
            \textbf{Frameworks/Libraries:} Android Jetpack, React, NestJS, FastAPI, Laravel, Tailwind, Chakra-UI \par
            \textbf{Databases:} PostgreSQL, MongoDB, Redis, InfluxDB \par
            \textbf{Cloud \& DevOps:} AWS (EC2, S3, RDS), Docker, Kubernetes, GitHub Actions, Helm, CI/CD, Git \par
